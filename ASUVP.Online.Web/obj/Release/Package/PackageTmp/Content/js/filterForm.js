...
//Класс панели
        ...
        pathToTabImage: ROOT_URL + '/Content/img/Filter.png',				//Путь к изображению кнопки
        imageHeight: '36px',						//Высота кнопки
...
(function ($) {
    $.fn.tabSlideOut = function (callerSettings) {
        ...
        var properties = {
            ...
            //containerHeight: parseInt(obj.outerHeight(), 10) + 'px', //height filter panel
