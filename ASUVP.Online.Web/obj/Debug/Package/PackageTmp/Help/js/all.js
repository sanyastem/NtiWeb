...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Введение","2. Функционал","2.1. Контакты","2.2. Договоры","2.3. Заявки","2.4. Протоколы","2.5. Счета","2.6. Инструкции","2.7. Акты","2.8. Администратор","2.8.1. Пользователи","2.8.2. Роли"],
    DREX_NODE_LINKS: ["index.htm","vvedenie.htm","funktsional.htm","kontakty.htm","dogovory.htm","zayavki.htm","protokoly.htm","scheta.htm","instruktsii.htm","akty.htm","administrator.htm","polzovateli.htm","roli.htm"],
    DREX_NODE_CHILD_START: [1,3,3,11,11,11,11,11,11,11,11,13,13],
    DREX_NODE_CHILD_END: [3,3,11,11,11,11,11,11,11,11,13,13,13],
    DREX_MENU_TYPE: 1,
